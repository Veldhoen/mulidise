...
We also highlight the difference between approaches that rely on local word context and co-occurrence within sentences, and relate this to word alignments.
